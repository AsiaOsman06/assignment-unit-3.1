...
let favoriteFoods = ['Pizza', 'Fries', 'Chicken', 'Fish', 'Salmon'];
...
// animalArray[animalArray.length - 1] try this on console it worked 
animalArray.length;
...
let dessert = 'Cheesecakes';
favoriteFoods.push(dessert);
console.log('Added a dessert to ',favoriteFoods);
...
let entree = 'Caesar Salad';
favoriteFoods.unshift(entree);
console.log(`Added a entree to beginning: ${favoriteFoods}`);
...
gems[1] = 'Tourmaline';
console.log('Replace second gem: ',gems);
...
// console.log('sorted Array: ',gems.reverse);
// console.log(gems);
